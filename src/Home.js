...
import { Container, InputGroup, FormControl, Button, Row, Card, CardGroup, Nav, Image, Modal } from 'react-bootstrap';
...
export default function Home(){
    ...
    function addTrackToPlaylistFunction(track,id){
      var executed = false;
      return function(){
        if(!executed){
          executed= true;
        ...
        <Container>
          <InputGroup className="mb-3" size="lg">
            <FormControl
              ...
              <Button variant='primary' onClick={handleShow_showSetPlayListModal} style={{backgroundColor:'orange'}}>
                Set Playlist
              </Button>
                                        ...
                                        <div>
                                          ...
                                          >
                                            ...
                                            {hoveredTrack && (
                                              ...
                                              onClick={addTrackToPlaylistFunction(track.name,track.id)}
                                              >
                                                Add
                                              </Button>
                                            )}</Card.Title>
