...
//                 if(id === test){
//                     token = users[i]._id
//                     const getFriends = await fetch(process.env.REACT_APP_BACKEND_URL+'/api/users/' + token)
//                     .then(result => result.json())
...
//                 const query = await fetch(process.env.REACT_APP_BACKEND_URL+'/api/users/' + user)
//                 .then(result => result.json())
